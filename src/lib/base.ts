...
export default class Base {
    ...
    constructor(adapter: WebWatch | null, id: number, name: string, config: any) {
    ...
    GetForbiddenChars(): RegExp {
     ...
     async Start(param: string | null): Promise<string | void> {
    ...
    async safeSetState (key: string, ack: boolean, value: any): Promise<void> {
        try {
